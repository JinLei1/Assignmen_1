...
#
# merged_table = pd.merge(contact_info_file,other_info_file,left_on="respondent_id", right_on="id").drop('id', axis=1)
#
# drop1 = merged_table.dropna()
#
# drop2 = drop1[~(drop1['job'].str.contains("insurance|Insurance"))]
